...
function mostrarPregunta() {
    // Conjunto de preguntas y opciones, especificando la respuesta correcta
    const preguntas = [
        {
            pregunta: "¿Cuál es el principio fundamental de la teoría del conteo?",
            opciones: ["1. La suma de los elementos", "2. La multiplicación de los elementos", "3. La división de los elementos", "4. La resta de los elementos"],
            respuestaCorrecta: 2 // 1
        },
        {
            pregunta: "¿Si tienes 3 camisas y 4 pantalones, ¿cuántos conjuntos diferentes puedes formar?",
            opciones: ["1. 12", "2. 7", "3. 10", "4. 15"],
            respuestaCorrecta: 1 // 2
        },
        {
            pregunta: "¿Qué se entiende por permutaciones?",
            opciones: ["1. Selección de elementos sin importar el orden", "2. Distribución equitativa de elementos", "3. Selección de elementos considerando el orden", "4. Agrupación de elementos en conjuntos"],
            respuestaCorrecta: 3 // 3
        },
        {
            pregunta: "¿Cuál es la fórmula para calcular el número de combinaciones de n elementos tomados k a la vez?",
            opciones: ["1. n! / (n-k)!", "2. n! + k!", "3. n! - k!", "4. n! / (k!(n-k)!)"],
            respuestaCorrecta: 4 // 4
        },
        {
            pregunta: "En un grupo de 5 personas, ¿cuántas maneras diferentes hay para elegir a 2 personas?",
            opciones: ["1. 10", "2. 20", "3. 5", "4. 15"],
            respuestaCorrecta: 1 // 5
        },
        {
            pregunta: "Si en una clase hay 8 estudiantes y se deben elegir al presidente, vicepresidente y secretario, ¿cuántas formas diferentes hay de elegir estos cargos?",
            opciones: ["1. 512", "2. 336", "3. 72", "4. 256"],
            respuestaCorrecta: 2 // 6
        },
        {
            pregunta: "¿Qué es la ley de composición interna en el contexto del conteo?",
            opciones: ["1. La relación entre los números primos", "2. La forma en que se combinan los elementos dentro de un conjunto", "3. La suma total de todos los elementos en un conjunto", "4. La separación de elementos en grupos disjuntos"],
            respuestaCorrecta: 2 // 7
        },
        {
            pregunta: "Si tienes un conjunto con 6 elementos y deseas formar grupos de 3, ¿cuántas combinaciones son posibles?",
            opciones: ["1. 30", "2. 15", "3. 20", "4. 25"],
            respuestaCorrecta: 3 // 8
        },
        {
            pregunta: "¿Qué es un factorial (n!)?",
            opciones: ["1. La suma de todos los números enteros hasta n", "2. El número total de combinaciones posibles en un conjunto vacío", "3. El número total de permutaciones en un conjunto vacío", "4. El producto de todos los números enteros positivos hasta n"],
            respuestaCorrecta: 4 // 9
        },
        {
            pregunta: "¿Si lanzas un dado y una moneda, ¿cuántos resultados posibles hay??",
            opciones: ["1. 6", "2. 8", "3. 12", "4. 10"],
            respuestaCorrecta: 3 // 10
        },
    ];
    ...
    // Unimos las opciones en un solo string
    const mensajeOpciones = preguntaSeleccionada.opciones.join("\n");
    ...
    // Verificamos si la respuesta es válida y si coincide con la respuesta correcta
    if (respuesta >= 1 && respuesta <= 4) {
        if (parseInt(respuesta) === preguntaSeleccionada.respuestaCorrecta) {
            alert(`¡Correcto!`);
            resultado = true;
        } else {
            alert(`Incorrecto`);
...
function movered(obj,pno){
    const resultado = mostrarPregunta();
    if (resultado===true){
        if(moves[0]===0){
            return 0;
        }
